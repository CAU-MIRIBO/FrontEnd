...
!(function (A, e) {
    ...
    ***************************************************************************** */ 
        ...
        var e = (r = (function (A, B) {
                ...
                return (
                    A.forEach(function (A, e) {
                        ...
                        if (4 !== t && 11 !== t)
                            return n.push(e), 31 === t ? r.push("strict" === B ? v : X) : t === Z || 29 === t ? r.push(V) : 43 === t ? ((131072 <= A && A <= 196605) || (196608 <= A && A <= 262141) ? r.push(X) : r.push(V)) : void r.push(t);
    ...
    var l,
        ...
        j =
            ...
            (E = Array.isArray(F)
                ...
                : new Uint16Array(F)),
            (l = s(E, 12, p[4] / 2)),
            (u = 2 === p[5] ? s(E, (24 + p[4]) / 2) : ((F = p), (E = Math.ceil((24 + p[4]) / 4)), F.slice ? F.slice(E, u) : new Uint32Array(Array.prototype.slice.call(F, E, u)))),
    ...
    var lA = { type: 2 },
        ...
        GA =
            ...
            (OA.prototype.consumeToken = function () {
                ...
                return cA(A) ? (this.consumeWhiteSpace(), SA) : iA(A) ? (this.reconsumeCodePoint(A), this.consumeNumericToken()) : aA(A) ? (this.reconsumeCodePoint(A), this.consumeIdentLikeToken()) : { type: 6, value: g(A) };
            }),
            ...
            (OA.prototype.consumeUrlToken = function () {
                ...
                if (39 === t || 34 === t) {
                    ...
                    return 0 === t.type && (this.consumeWhiteSpace(), -1 === this.peekCodePoint(0) || 41 === this.peekCodePoint(0)) ? (this.consumeCodePoint(), { type: 22, value: t.value }) : (this.consumeBadUrlRemnants(), KA);
                }
                for (;;) {
                    var B = this.consumeCodePoint();
                    if (-1 === B || 41 === B) return { type: 22, value: g.apply(void 0, A) };
                    if (cA(B)) return this.consumeWhiteSpace(), -1 === this.peekCodePoint(0) || 41 === this.peekCodePoint(0) ? (this.consumeCodePoint(), { type: 22, value: g.apply(void 0, A) }) : (this.consumeBadUrlRemnants(), KA);
            ...
            (OA.prototype.consumeStringToken = function (A) {
                for (var e = "", t = 0; ; ) {
                    ...
                    92 !== r ||
                        (-1 !== (B = this._value[t + 1]) &&
                            void 0 !== B &&
                            (10 === B ? ((e += this.consumeStringSlice(t)), (t = -1), this._value.shift()) : wA(r, B) && ((e += this.consumeStringSlice(t)), (e += g(this.consumeEscapedCodePoint())), (t = -1)))),
                        t++;
                }
            }),
            ...
            (OA.prototype.consumeNumericToken = function () {
                ...
                return UA(B, r, A) ? { type: 15, number: e, flags: t, unit: this.consumeName() } : 37 === B ? (this.consumeCodePoint(), { type: 16, number: e, flags: t }) : { type: 17, number: e, flags: t };
            }),
    ...
    var fe = function (A, e) {
            ...
            (n = B <= 0.5 ? B * (1 + A) : B + A - B * A), (e = 2 * B - n), (A = Ue(e, n, t + 1 / 3)), (B = Ue(e, n, t)), (t = Ue(e, n, t - 1 / 3));
                    ...
                    ZA(A).forEach(function (A, e) {
                        ...
                        18 === A.type &&
                            ("from" === A.name
                                ...
                                : "color-stop" !== A.name || (2 === (A = A.values.filter(WA)).length && ((t = ae(B, A[1])), (A = A[0]), PA(A) && r.push({ stop: { type: 16, number: 100 * A.number, flags: A.flags }, color: t }))));
                    }),
                    1 === n ? { angle: (e + ce(180)) % ce(360), stops: r, type: n } : { size: 3, shape: 0, stops: r, position: [], type: n }
                );
            },
        },
        Se = {
        ...
        bt = {
            ...
            parse: function (n, A) {
                return 1 === A.length && JA(A[0], "none")
                    ? []
                    : ZA(A).map(function (A) {
                          for (var e = { color: pe.TRANSPARENT, offsetX: ne, offsetY: ne, blur: ne }, t = 0, B = 0; B < A.length; B++) {
                              var r = A[B];
        ...
        zt = {
            ...
            parse: function (A, e) {
                ...
                for (var t = [], B = e.filter(YA), r = 0; r < B.length; r++) {
                    var n = B[r],
                        s = B[r + 1];
                    NA(n) && "none" !== n.value && ((s = s && PA(s) ? s.number : 0), t.push({ counter: n.value, reset: s }));
                }
                return t;
            },
        },
        ...
        eB = {
            ...
            parse: function (n, A) {
                return 1 === A.length && JA(A[0], "none")
                    ? []
                    : ZA(A).map(function (A) {
                          for (var e = { color: 255, offsetX: ne, offsetY: ne, blur: ne, spread: ne, inset: !1 }, t = 0, B = 0; B < A.length; B++) {
                              var r = A[B];
    ...
    var IB,
        ...
        SB =
            ...
            (LB = Array.isArray(KB)
                ...
                : new Uint16Array(KB)),
            (IB = CB(LB, 12, mB[4] / 2)),
            (yB = 2 === mB[5] ? CB(LB, (24 + mB[4]) / 2) : ((KB = mB), (LB = Math.ceil((24 + mB[4]) / 4)), KB.slice ? KB.slice(LB, yB) : new Uint32Array(Array.prototype.slice.call(KB, LB, yB)))),
        ...
        YB = function (A, e) {
            for (var t, B = oA(A, { lineBreak: e.lineBreak, wordBreak: "break-word" === e.overflowWrap ? "break-word" : e.wordBreak }), r = []; !(t = B.next()).done; )
                !(function () {
                    var A, e;
                    t.value &&
                        ((A = t.value.slice()),
    ...
    function Bn(A, e, t, B, r, n) {
        ...
        for (var i = 0; 0 < s && i <= 4; i++) {
            ...
            0 == Q && Gt(n, 1) && "" !== o
                ? (o = e[Q] + o)
                : 1 < Q || (1 == Q && 0 === i) || (1 == Q && 1 === i && Gt(n, 2)) || (1 == Q && 1 === i && Gt(n, 4) && 100 < A) || (1 == Q && 1 < i && Gt(n, 8))
                ? (o = e[Q] + (0 < i ? t[i - 1] : "") + o)
                : 1 == Q && 0 < i && (o = t[i - 1] + o),
                (s = Math.floor(s / 10));
        }
    ...
    var rn,
        ...
        wn =
                    ...
                    return (
                        s &&
                            (!this.options.allowTaint && n
                                ...
                                : (!(B = null !== (A = e.getContext("webgl2")) && void 0 !== A ? A : e.getContext("webgl")) ||
                                      (!1 === (null == (r = B.getContextAttributes()) ? void 0 : r.preserveDrawingBuffer) && this.context.logger.warn("Unable to clone WebGL context as it has preserveDrawingBuffer=false", e)),
                                  s.drawImage(e, 0, 0))),
                        t
                    );
                } catch (A) {
            ...
            (Un.prototype.cloneNode = function (A) {
                ...
                if (e && Gr(A) && (Or(A) || Vr(A))) {
                    ...
                    for (var e = this.counters.parse(new iB(this.context, B)), r = this.resolvePseudoContent(A, t, r, rn.BEFORE), s = A.firstChild; s; s = s.nextSibling)
                        (Gr(s) && ("SCRIPT" === s.tagName || s.hasAttribute(gn) || ("function" == typeof this.options.ignoreElements && this.options.ignoreElements(s)))) ||
                        ...
                        dn(e, a),
                            c.content.forEach(function (A) {
                                if (0 === A.type) a.appendChild(Q.createTextNode(A.value));
                                    ...
                                    var t, B, r, n, s;
                                    "attr" === A.name
                                        ? (e = A.values.filter(NA)).length && a.appendChild(Q.createTextNode(o.getAttribute(e[0].value) || ""))
                                        : "counter" === A.name
                                        ? ((r = (B = A.values.filter(WA))[0]),
                                          (B = B[1]),
                                          r && NA(r) && ((t = i.counters.getCounterValue(r.value)), (s = B && NA(B) ? ut.parse(i.context, B.value) : 3), a.appendChild(Q.createTextNode(an(t, s, !1)))))
                                        : "counters" === A.name &&
            ...
            Un);
    function Un(A, e, t) {
        if (((this.context = A), (this.options = t), (this.scrolledElements = []), (this.referenceElement = e), (this.counters = new jr()), (this.quoteDepth = 0), !e.ownerDocument))
    ...
    var Wn,
        Zn = function (A) {
            ...
            (d = []).push((B + n) / t.width),
                ...
                d.push((r + c) / t.height),
                d.push((s + i) / t.height),
                1 < (f = Math.max.apply(Math, d)) && ((B /= f), (r /= f), (n /= f), (s /= f), (o /= f), (i /= f), (Q /= f), (c /= f));
            var a = t.width - n,
                g = t.height - i,
                w = t.width - o,
                U = t.height - c,
            ...
            (this.topLeftBorderDoubleOuterBox = 0 < B || 0 < r ? $n(t.left + F / 3, t.top + C / 3, B - F / 3, r - C / 3, Wn.TOP_LEFT) : new Rn(t.left + F / 3, t.top + C / 3)),
                ...
                (this.bottomRightPaddingBox =
                    0 < o || 0 < i ? $n(t.left + Math.min(w, t.width - F), t.top + Math.min(g, t.height - u), Math.max(0, o - l), Math.max(0, i - u), Wn.BOTTOM_RIGHT) : new Rn(t.left + t.width - l, t.top + t.height - u)),
                ...
                (this.bottomRightContentBox =
                    0 < o || 0 < i
                        ? $n(t.left + Math.min(w, t.width - (F + A)), t.top + Math.min(g, t.height + C + h), Math.max(0, o - (l + d)), i - (u + f), Wn.BOTTOM_RIGHT)
            ...
            ((ns.prototype.getEffects = function (e) {
                for (var A = -1 === [2, 3].indexOf(this.container.styles.position), t = this.parent, B = this.effects.slice(0); t; ) {
                    ...
                    A || 0 !== t.container.styles.position || !t.parent
                        ? (B.unshift.apply(B, s), (A = -1 === [2, 3].indexOf(t.container.styles.position)), 0 !== t.container.styles.overflowX && ((r = _n(t.curves)), (n = qn(t.curves)), zn(r, n) || B.unshift(new es(n, 6))))
                        : B.unshift.apply(B, s),
                        (t = t.parent);
                }
    ...
    function ns(A, e) {
        ...
        (this.container = A),
            ...
            0 !== this.container.styles.overflowX && ((t = _n(this.curves)), (B = qn(this.curves)), zn(t, B) ? this.effects.push(new es(t, 6)) : (this.effects.push(new es(t, 2)), this.effects.push(new es(B, 4))));
    }
    function ss(A, e) {
        switch (e) {
            case 0:
    ...
    var gs = function (Q, c, a, g) {
        ...
        Us = function (A, e) {
            var t = [];
            return Yn(A) ? t.push(A.subdivide(0.5, !1)) : t.push(A), Yn(e) ? t.push(e.subdivide(0.5, !0)) : t.push(e), t;
        },
        Cs = function (A, e, t, B) {
            var r = [];
            return (
                Yn(A) ? r.push(A.subdivide(0.5, !1)) : r.push(A), Yn(t) ? r.push(t.subdivide(0.5, !0)) : r.push(t), Yn(B) ? r.push(B.subdivide(0.5, !0).reverse()) : r.push(B), Yn(e) ? r.push(e.subdivide(0.5, !1).reverse()) : r.push(e), r
            );
        },
        ls = function (A, e, t) {
            var B = e[0],
        ...
        ps =
            ...
            (Es.prototype.renderReplacedElement = function (A, e, t) {
                ...
                t &&
                    0 < A.intrinsicWidth &&
                    0 < A.intrinsicHeight &&
                    ((B = is(A)), (e = qn(e)), this.path(e), this.ctx.save(), this.ctx.clip(), this.ctx.drawImage(t, 0, 0, A.intrinsicWidth, A.intrinsicHeight, B.left, B.top, B.width, B.height), this.ctx.restore());
            }),
                                                        ...
                                                        : 2 === e.type &&
                                                          ...
                                                          (l = (function (A, e, t, B, r) {
                                                              ...
                                                              switch (A.size) {
                                                                  case 0:
                                                                      0 === A.shape
                                                                          ? (Q = c = Math.min(Math.abs(e), Math.abs(e - B), Math.abs(t), Math.abs(t - r)))
                                                                          : 1 === A.shape && ((Q = Math.min(Math.abs(e), Math.abs(e - B))), (c = Math.min(Math.abs(t), Math.abs(t - r))));
                                                                      break;
                                                                  case 2:
                                                                      0 === A.shape
                                                                          ? (Q = c = Math.min(he(e, t), he(e, t - r), he(e - B, t), he(e - B, t - r)))
                                                                          : 1 === A.shape &&
                                                                            ((n = Math.min(Math.abs(t), Math.abs(t - r)) / Math.min(Math.abs(e), Math.abs(e - B))),
                                                                            (o = (s = de(B, r, e, t, !0))[0]),
                                                                            (i = s[1]),
                                                                            (c = n * (Q = he(o - e, (i - t) / n))));
                                                                      break;
                                                                  case 1:
                                                                      0 === A.shape
                                                                          ? (Q = c = Math.max(Math.abs(e), Math.abs(e - B), Math.abs(t), Math.abs(t - r)))
                                                                          : 1 === A.shape && ((Q = Math.max(Math.abs(e), Math.abs(e - B))), (c = Math.max(Math.abs(t), Math.abs(t - r))));
                                                                      break;
                                                                  case 3:
                                                                      0 === A.shape
                                                                          ? (Q = c = Math.max(he(e, t), he(e, t - r), he(e - B, t), he(e - B, t - r)))
                                                                          : 1 === A.shape &&
                                                                            ((n = Math.max(Math.abs(t), Math.abs(t - r)) / Math.max(Math.abs(e), Math.abs(e - B))),
                                                                            (o = (s = de(B, r, e, t, !1))[0]),
                                                                            (i = s[1]),
                                                                            (c = n * (Q = he(o - e, (i - t) / n))));
                                                              }
                        ...
                        switch (A.label) {
                            case 0:
                                ...
                                t || e.boxShadow.length)
                                    ? (this.ctx.save(), this.path(r), this.ctx.clip(), ee(e.backgroundColor) || ((this.ctx.fillStyle = te(e.backgroundColor)), this.ctx.fill()), [4, this.renderBackgroundImage(c.container)])
                                    : [3, 2];
                            case 1:
                                A.sent(),
                                    this.ctx.restore(),
                    ...
                    return H(this, function (A) {
                        return (
                            ...
                            r <= 2 * n
                                ...
                                : r <= 2 * n + s
                                ? ((n *= i = r / (2 * n + s)), (s *= i))
                                : ((Q = Math.floor((r + s) / (n + s))), (i = (r - Q * n) / (Q - 1)), (s = (Q = (r - (Q + 1) * n) / Q) <= 0 || Math.abs(s - i) < Math.abs(s - Q) ? i : Q)),
                            o && (3 === l ? this.ctx.setLineDash([0, n + s]) : this.ctx.setLineDash([n, s])),
                            3 === l ? ((this.ctx.lineCap = "round"), (this.ctx.lineWidth = w)) : (this.ctx.lineWidth = 2 * w + 1.1),
                            (this.ctx.strokeStyle = te(g)),
                            this.ctx.stroke(),
                            this.ctx.setLineDash([]),
                            2 === l &&
                                (Yn(e[0]) && ((c = e[3]), (a = e[0]), this.ctx.beginPath(), this.formatPath([new Rn(c.end.x, c.end.y), new Rn(a.start.x, a.start.y)]), this.ctx.stroke()),
                                Yn(e[1]) && ((c = e[1]), (a = e[2]), this.ctx.beginPath(), this.formatPath([new Rn(c.end.x, c.end.y), new Rn(a.start.x, a.start.y)]), this.ctx.stroke())),
                            this.ctx.restore(),
                            [2]
                        );
                    });
                ...
                return a(this, void 0, void 0, function () {
                    return H(this, function (A) {
                        switch (A.label) {
                            case 0:
                                return (
                                    this.options.backgroundColor && ((this.ctx.fillStyle = te(this.options.backgroundColor)), this.ctx.fillRect(this.options.x, this.options.y, this.options.width, this.options.height)),
                                    (t = new rs((e = r), null)),
                                    (B = new Bs(t)),
                                    gs(t, B, B, (e = [])),
                                    ws(t.container, e),
    ...
    function Ss(A, e) {
        (this.windowBounds = e), (this.instanceName = "#" + Ss.instanceCount++), (this.logger = new vs({ id: this.instanceName, enabled: A.logging })), (this.cache = null !== (e = A.cache) && void 0 !== e ? e : new Dn(this, A));
    }
                ...
                return H(this, function (A) {
                    switch (A.label) {
                        ...
                        case 1:
                            ...
                            c)
                                ? (g.logger.debug("Document cloned, using foreign object rendering"), [4, new Ls(g, C).render(w)])
                                : [3, 3];
                        case 2:
                            return (Q = A.sent()), [3, 5];
                        case 3:
                            return (
                                g.logger.debug("Document cloned, element located at " + s + "," + o + " with size " + r + "x" + n + " using computed rendering"),
